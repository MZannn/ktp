  ...
  static final API _api = API._internal(
    Dio(
      BaseOptions(
        ...
        connectTimeout: Constant.timeout,
...
class KTPApi {
  ...
  Future get<T extends Object?>(
    ...
    if (withToken) {
      ...
      try {
        final response = await KTPApi().api.dio.get<T>(
              path,
  ...
  Future post<T extends Object?>(
    ...
    if (withToken) {
      try {
        final response = await KTPApi().api.dio.post<T>(
              path,
              data: formdata,
              options: Options(
                headers: {
  ...
  Future put<T extends Object?>(
    ...
    if (withToken) {
      try {
        final response = await KTPApi().api.dio.put<T>(
              path,
              data: formdata,
              options: Options(
                headers: {
